...
import LoginIllustration from "@/public/login-animate.svg?react";
import LogoComponents from "@/public/NetQuest4.svg?react";

export default function LoginPage() {
	return (
		// max-h-[95vh] mencegah kartu lebih tinggi dari layar
		<div className="flex flex-col lg:flex-row w-full bg-base-200/40 backdrop-blur-2xl border border-white/10 shadow-[0_8px_40px_rgba(0,0,0,0.2)] rounded-[2rem] md:rounded-[3rem] overflow-hidden relative max-h-full">
			<div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-primary via-secondary to-primary opacity-50" />

			{/* Sisi Kiri: Ilustrasi */}
			<div className="hidden md:flex flex-1 flex-col items-center justify-center p-6 lg:p-10 bg-gradient-to-br from-primary/5 to-transparent relative overflow-hidden border-b lg:border-b-0 lg:border-r border-white/5">
