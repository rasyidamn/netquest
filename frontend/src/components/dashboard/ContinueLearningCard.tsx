...
import { IconArrowRight, IconPlayerPlay, IconTargetArrow } from "@tabler/icons-react";
...
export function ContinueLearningCard({ isLoading, progress }: ContinueLearningCardProps) {
   ...
   return (
      <div className="card relative overflow-hidden bg-gradient-to-br from-primary/10 via-base-200/60 to-secondary/5 backdrop-blur-xl border border-primary/20 shadow-[0_8px_30px_rgba(var(--color-primary),0.1)] group">
         ...
         <div className="card-body p-6 sm:p-8 flex-col sm:flex-row items-start sm:items-center gap-6 relative z-10">
            ...
            <div className="relative shrink-0">
               ...
               <div className="relative flex size-16 items-center justify-center rounded-2xl bg-primary/20 border border-primary/30 text-primary shadow-[0_0_20px_rgba(var(--color-primary),0.3)] backdrop-blur-md transition-transform duration-500 group-hover:scale-110">
                  <IconPlayerPlay size={32} className="ml-1" fill="currentColor" />
               </div>
            </div>
            ...
            <div className="flex-1 w-full">
               ...
               <p className="mt-1.5 text-sm font-medium text-base-content/60 flex items-center gap-1.5">
                  <IconTargetArrow size={16} className="opacity-70" />
            ...
            <div className="shrink-0 mt-4 sm:mt-0 w-full sm:w-auto">
               <button
                  onClick={() => router.navigate({ 
                     to: activeModule.moduleId ? `/roadmap/${activeModule.moduleId}` : "/roadmap" 
                  })}
