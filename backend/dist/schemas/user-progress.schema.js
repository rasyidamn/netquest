...
export class UserProgressSchema {
    // 1. Model Dasar
    static USER_PROGRESS_MODEL = z.object({
        id: z
            .uuid()
    ...
    static CREATE_USER_PROGRESS_REQUEST = this.USER_PROGRESS_MODEL.omit({
        id: true,
    })
        .extend({
    ...
    static UPDATE_USER_PROGRESS_REQUEST = this.CREATE_USER_PROGRESS_REQUEST.partial().strict();
    // 4. Skema URL Parameter
    static USER_PROGRESS_ID_PARAM = z.object({
